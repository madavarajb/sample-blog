...
const FeaturesTiles = ({
  ...
  const sectionHeader = {
    title: 'Build your Own Anime Empire',
    paragraph: 'Anime is a word used to describe a style of animation originating in Japan. Anime is different because it is more than just heartbreak, action, fighting, and melodrama, but also it’s a place to explore the boundaries of the imagination.'
  };
